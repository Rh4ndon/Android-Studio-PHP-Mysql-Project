...
<body>
<?php $query= mysqli_query($conn,"select * from parent where parent_id = '$session_id'")or die(mysqli_error());
  ...
  <div class="profile-card">
    ...
    <a href="navbar_parent.php" type="button" class="btn">Back to Home</a>
    </div>
  </div>
</section>
...
<?php
 include('dbcon.php');
                            ...
                            if (isset($_POST['update'])) {
								...
								mysqli_query($conn,"update parent set username = '$un', fullname = '$fn', contact = '$cp', age = '$age', password = '$pass' where parent_id  = '$session_id' ")or die(mysqli_error());
								
								?>
 
								<script>
								window.location = "parent_profile.php";  
								</script>
 ...
 include('dbcon.php');
                            ...
                            if (isset($_POST['save'])) {
								...
								mysqli_query($conn,"update parent set profile = '$location' where parent_id  = '$session_id' ")or die(mysqli_error());
