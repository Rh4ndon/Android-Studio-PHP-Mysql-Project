	...
	<div class="screen">
		...
		<div class="screen__background">
			...
			<span class="screen__background__shape screen__background__shape1"></span>
                ...
                <!-- /Form for parent registration -->
                <!-- Method Post for parent registration -->
                <?php
                            @include 'dbcon.php';
                            if (isset($_POST['save'])) {
								...
								$query = mysqli_query($conn,"select * from parent where username = '$username' && fullname = '$fullname' ")or die(mysqli_error());
                                ...
                                mysqli_query($conn,"insert into parent (username,fullname,age,contact,password,profile)
