...
<div>
  ...
  <table class="rwd-table">
    ...
    <tr>
      ...
      <tr>
        <!-- mysql query on who was the student being edit the $get_id was use to determin which row is being edit -->
<?php
              @include 'dbcon.php';
							...
							?>
              <!-- /mysql query -->
              <!-- This is the form use to get the updates -->
  <form method="post">
	<td data-th="Lastname">				
  ...
  <tr>
    ...
    <td>
  <button><a href="angeles_spj.php" type="button">Back</a></button>
  <a href="">Back</a>
...
<!-- This is the method updat use to send the updates to the mysql database 
it hase values get from above inputs then inject to database
-->
<?php
                ...
                health1 = '$he1' , health2 = '$he2' , health3 = '$he3' , health4 = '$he4' , health5 = '$he5' , research1 = '$re1' , research2 = '$re2' , research3 = '$re3' , research4 = '$re4' , research5 = '$re5' , gen1 = '$genave1', gen2 = '$genave2', gen3 = '$genave3', gen4 = '$genave4',  genaverage = '$genave' , status = 'Unchecked'  where student_id = '$get_id' ")or die(mysqli_error());
								...
								<script>
                  alert 
								window.location = "angeles_spj.php";
