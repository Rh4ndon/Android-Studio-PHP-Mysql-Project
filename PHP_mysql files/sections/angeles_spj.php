...
<!-- Page ID use for editing students so that when close it will goback to this page-->
<?php $page_id = '7-Angeles'; ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<!--/table-->
  <!-- Add student buttons-->
  <button class="open-modal" data-target="modal-1"><a href="add_student.php"><i class="fa fa-plus"></i></a></button>
  </div>
